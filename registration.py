    ...
    # ✅ STEP 0.8: UPLOAD PAN CARD
        ...
        if file_uploaded and file_uploaded.get("doc_type") == "pan_card":
            ...
            if not result.get("is_valid"):
                session["step"] = "upload_pan_card"
                response = {
                    "response": result.get("validation_error", get_translated_message("invalid_pan", user_language)),
                    "type": "error",
                    "waiting_for": "pan_card_upload"
                }
            else:
                ...
                # TODO: Implement actual Aadhaar-PAN linking verification
                # For now, we'll assume they are linked
                # In production, call Income Tax API to verify linking
                
                is_linked = True  # Replace with actual API call
